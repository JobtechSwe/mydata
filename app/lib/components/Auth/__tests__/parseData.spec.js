import { toViewModel, toPermissionResult } from '../parseData'
...
describe('components/Auth/parseData', () => {
  ...
  describe('#toConnection', () => {
    ...
    let appKeyBaseData, appKeyExperience
    beforeEach(() => {
      appKeyBaseData = {
        e: 'AQAB',
    ...
    it('transforms a view model response into a CONNECTION message', () => {
      const expected = [
        {
          area: 'baseData',
          domain: 'https://mycv.work',
        ...
        },
        {
          ...
          type: 'WRITE',
          jwks: {
            keys: [appKeyBaseData, baseDataKey],
          },
        },
        {
          area: 'experience',
          ...
          type: 'WRITE',
          jwks: {
            keys: [appKeyExperience, experienceKey],
          },
        },
        {
          area: 'experience',
